...
public class Main3 extends SimpleApplication
{
	...
	public static String directory = "Nuxi_2A";
	...
	public static void main(String[] args)
	{
		...
		if(Toolkit.getDefaultToolkit().getScreenSize().width > 1400)
		{
	...
	public void simpleInitApp()
	{
		...
		Book2 b2 = new Book2(this, new ThreadSummoner(new EntrySplitter(Loader.gibText("Text"))));
		Node node = new Node();
